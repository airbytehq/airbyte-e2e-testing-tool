...
import static io.airbyte.testingtool.argument_parser.RunArgumentFactory.RUN_COMMAND_ARGUMENT;
...
public class ArgumentParser {
  ...
  private static String getArgumentKey(String arg) {
    return arg.startsWith(COMMAND_START_CHAR) ? RUN_COMMAND_ARGUMENT : splitAndGetArgumentPart(arg, true);
  }
